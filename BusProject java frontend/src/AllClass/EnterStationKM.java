...
public class EnterStationKM extends JFrame implements ActionListener {
	private Container c;
	...
	public EnterStationKM(String stid,String txt1)
    {
        ...
        if(bb1==-1 || EnterStationKM.n<4 || EnterStationKM.n>13) {
        	tnumsta.setBorder(BorderFactory.createLineBorder(Color.decode("#FF0000")));
        }
        c.add(tnumsta);
	...
	public void actionPerformed(ActionEvent e)
    {
       ...
       if(txt12.length()==0 || stid12.length()==0) {
           ...
           if(stid12.length()==0) {
        	...
        	EnterStationKM sn=new EnterStationKM (stid12,txt12);
        }else if(bb1==-1) {
        ...
        }else if(bb1==0 && EnterStationKM.n<4 || EnterStationKM.n>13 ) {
        	f=-1;
        ...
        NewStationKM n= new NewStationKM (txt2,stid12,sqlOne,sqlTwo,sqlThree,sqlFour,sqlFive,sqlSix,sqlSeven,sqlEight,sqlNine,sqlTen,sqlEleven,sqlTwowelv,sqlThrteen);
        }
