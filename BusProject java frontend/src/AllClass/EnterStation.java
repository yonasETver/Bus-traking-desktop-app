...
public class EnterStation extends JFrame implements ActionListener {
	private Container c;
	...
	public EnterStation(String stid,String txt1)
    {
		 setIconImage(icon); 
        ...
        if(bb1==-1 || EnterStation.n<4 || EnterStation.n>13) {
        	tnumsta.setBorder(BorderFactory.createLineBorder(Color.decode("#FF0000")));
        }
        c.add(tnumsta);
	...
	public void actionPerformed(ActionEvent e)
    {
        ...
        if(s.equals("Ok")) {
            ...
            if(txt12.length()==0 || stid12.length()==0) {
                ...
                EnterStation sn=new EnterStation (stid12,txt12);
            }else if(bb1==-1) {
            ...
            this.setVisible(false);
        	NewStation n= new NewStation(txt2,stid12,sqlOne,sqlTwo,sqlThree,sqlFour,sqlFive,sqlSix,sqlSeven,sqlEight,sqlNine,sqlTen,sqlEleven,sqlTwowelv,sqlThrteen,sql14);
